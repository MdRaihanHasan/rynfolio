    ...
    <div className="main-sidebar rmt-65">
        ...
        <ul>
            ...
            <div className="content">
              <div className="blog-meta mb-5">
                <a className="date" href="#">
                  <i className="far fa-calendar-alt"></i> Sep 25, 2023
                </a>
              </div>
              <h5>
          ...
          <li>
            ...
            <div className="content">
              ...
              <h5>
                <Link href="/blog-details">Online Environment Work</Link>
              </h5>
            </div>
          </li>
        </ul>
      ...
      <div className="widget widget-cta wow fadeInUp delay-0-2s">
        <div
          ...
          style={{ backgroundImage: "url(/assets/images/widgets/widget-cta.jpg)" }}
        >
